...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'WhereToBuy'
        db.create_table(u'base_wheretobuy', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('pos_type', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('order', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'base', ['WhereToBuy'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'WhereToBuy'
        db.delete_table(u'base_wheretobuy')
    ...
    models = {
        ...
        u'base.news': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 24, 0, 0)', 'max_length': '255'}),
