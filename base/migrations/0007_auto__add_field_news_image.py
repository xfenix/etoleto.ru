...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'base_news', 'image',
                      self.gf('base.utils.ImagePreviewField')(default=datetime.datetime(2014, 5, 5, 0, 0), max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'News.image'
        db.delete_column(u'base_news', 'image')
